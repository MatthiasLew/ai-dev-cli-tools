...
| `build_context` | Task-relevant files, symbols, diffs, tests, and evidence | Preview-only unless `write_artifacts=true`; supports `implement` and `docs` profiles | local write |
